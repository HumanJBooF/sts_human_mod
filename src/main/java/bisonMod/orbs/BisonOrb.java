...
public class BisonOrb extends AbstractOrb {

    // Standard ID/Descritpion
    public static final String ORB_ID = bisonMod.makeID("BisonOrb");
    ...
    public BisonOrb() {
        ...
        this.img = ImageMaster.loadImage("bisonModResources/images/orbs/default_orb.png");

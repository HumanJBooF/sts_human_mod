...
public class BisonSecondMagicNumberSkill extends AbstractBisonCard {
     ...
     * variables.BisonMagicNumber and cards.AbstractBisonCard
     *
    ...
    public static final String ID = bisonMod.makeID("BisonSecondMagicNumberSkill");
    ...
    public BisonSecondMagicNumberSkill() {

...
import bisonMod.powers.RarePower;

public class BisonRarePower extends CustomCard {
    ...
    public static final String ID = bisonMod.makeID("BisonRarePower");

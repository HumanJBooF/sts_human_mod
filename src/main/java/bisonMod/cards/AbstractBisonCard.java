...
public abstract class AbstractBisonCard extends CustomCard {
    ...
    // simply use that in our cards, so long as we put "extends AbstractBisonCard" instead of "extends CustomCard" at the start.
    ...
    public AbstractBisonCard(final String id, final String name, final String img, final int cost, final String rawDescription,

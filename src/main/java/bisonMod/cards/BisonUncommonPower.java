...
import bisonMod.actions.UncommonPowerAction;
import bisonMod.bisonMod;
import bisonMod.patches.AbstractCardEnum;

public class BisonUncommonPower extends CustomCard {
    ...
    public static final String ID = bisonMod.makeID("BisonUncommonPower");

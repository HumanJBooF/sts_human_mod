...
public class BisonAttackWithVariable extends CustomCard {
    ...
    public static final String ID = bisonMod.makeID("BisonAttackWithVariable");
    ...
    public BisonAttackWithVariable() {

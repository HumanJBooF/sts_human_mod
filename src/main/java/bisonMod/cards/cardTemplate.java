...
// public class ${NAME} extends AbstractBisonCard
public class cardTemplate extends AbstractBisonCard {
    ...
    public static final String ID = bisonMod.makeID("BisonCommonAttack"); // bisonMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "bisonModResources/images/cards/Attack.png"; // "bisonModResources/images/cards/${NAME}.png"

...
public class PlaceholderRelic2 extends CustomRelic {
    ...
    // ID, images, text.
    public static final String ID = bisonMod.makeID("PlaceholderRelic2");
    public static final String IMG = "bisonModResources/images/relics/placeholder_relic2.png";
    public static final String OUTLINE = "bisonModResources/images/relics/outline/placeholder_relic2.png";

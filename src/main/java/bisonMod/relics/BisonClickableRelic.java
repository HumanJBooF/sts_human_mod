...
public class BisonClickableRelic extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = bisonMod.makeID("BisonClickableRelic");
    public static final String IMG = "bisonModResources/images/relics/default_clickable_relic.png";
    public static final String OUTLINE = "bisonModResources/images/relics/outline/default_clickable_relic.png";

    private boolean usedThisTurn = false; // You can also have a relic be only
    // usable once per combat. Check out Hubris for more examples, including other StSlib things.

    public BisonClickableRelic() {
    ...
    public void onRightClick() {// On right click
        if (!isObtained || usedThisTurn) {// If it has been used this turn,
            // or the player doesn't actually have the relic (i.e. it's on display in the shop room)
    ...
    public AbstractRelic makeCopy() {
        return new BisonClickableRelic();
    }
}

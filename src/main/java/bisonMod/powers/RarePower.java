...
import bisonMod.cards.BisonRareAttack;

public class RarePower extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = bisonMod.makeID("RarePower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final String IMG = "bisonModResources/images/powers/placeholder_power.png";
    ...
    public void atStartOfTurn() { // At the start of your turn
        AbstractCard playCard = new BisonRareAttack(); // Declare Card
